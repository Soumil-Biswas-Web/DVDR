...
MainChannel.loader = async ()  => {
  try {
    const response = await axios.get(
      `https://www.googleapis.com/youtube/v3/search?key=${import.meta.env.VITE_YOUTUBE_API_KEY}&channelId=${import.meta.env.VITE_DVDR_CINEMATICS_ID}&part=snippet,id&order=date&maxResults=12`
    );
